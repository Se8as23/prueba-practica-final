...
a persistence unit "eva62PesantezPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Pesantez/pom.xml":
...
artifact ("eva62Pesantez.war") is already built. You can build
